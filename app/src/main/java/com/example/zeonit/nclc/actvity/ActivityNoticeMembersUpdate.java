...
public class ActivityNoticeMembersUpdate extends Activity {private ListView listView;
    private Event event;
    ...
    private class myAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            View view1 = LayoutInflater.from(ActivityNoticeMembersUpdate.this).inflate(R.layout.activity_church_notice_attendance_row, null);
    ...
    private void startService(final String search) {
        ...
        class MyAsync extends AsyncTask<String,String,String> {
            ...
            ProgressDialog prograss = new ProgressDialog(ActivityNoticeMembersUpdate.this);
        ...
        class MyAsync extends AsyncTask<String,String,String> {
            ...
            protected String doInBackground(String... strings) {
                try {
                    ...
                    GsonBuilder gsonBuilder = new GsonBuilder();
                    Map<String,String> stringStringMap = new HashMap<>();
                    stringStringMap.put("is_update_notice","sd");
                    stringStringMap.put("leader_id",event.getLeaderID());
                    stringStringMap.put("notice_id",event.getNoticeID());
...
//                    stringStringMap.put("member",members);
            ...
            protected void onPostExecute(String response) {
                ...
                if(response != null){
                    ...
                    int state = jsonObject.get("state").getAsInt();
                    if(state == 1){
                        ActivityNoticeMembersUpdate.this.finish();
                        showDialog("Attendance","Success.....");
                        Intent intent = new Intent(ActivityNoticeMembersUpdate.this, NoticeActivity.class);
